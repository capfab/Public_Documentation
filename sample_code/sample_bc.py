...
def _update_BC(
    ...
    :param actor: _description_
    :type actor: Model
    :param expert_batch: _description_
    :type expert_batch: Batch
    :param args: _description_
    :type args: _type_
    :return: _description_
    :rtype: Tuple[PRNGKey, Model, InfoDict]
    """
...
class BC(BaseBC):
    def __init__(
        ...
        :type seed: int
        :param observations: _description_
        :type observations: jnp.ndarray
        :param actions: _description_
        :type actions: jnp.ndarray
        :param actor_lr: _description_
        :type actor_lr: float
        :param critic_lr: _description_
        :type critic_lr: float
        :param value_lr: _description_
        :type value_lr: float
        :param disc_lr: _description_
        :type disc_lr: float
        :param hidden_dims: _description_
        :type hidden_dims: Sequence[int]
        :param discount: _description_
        :type discount: float
        :param expectile: _description_
        :type expectile: float
        :param actor_temperature: _description_
        :type actor_temperature: float
        :param dropout_rate: _description_
        :type dropout_rate: float
        :param layernorm: _description_
        :type layernorm: bool
        :param tau: _description_
        :type tau: float
        :param double_q: _description_, defaults to True
        :type double_q: bool, optional
        :param opt_decay_schedule: _description_, defaults to "cosine"
        :type opt_decay_schedule: Optional[str], optional
        :param max_steps: _description_, defaults to None
        :type max_steps: Optional[int], optional
        :param value_dropout_rate: _description_, defaults to None
        :type value_dropout_rate: Optional[float], optional
        :param reward_gap: _description_, defaults to 2.0
        :type reward_gap: float, optional
        :param weight_decay: _description_, defaults to 0.0
        :type weight_decay: float, optional
        :param episode_length: _description_, defaults to 1000
        :type episode_length: int, optional
        :param action_repeat: _description_, defaults to 1
        :type action_repeat: int, optional
    ...
    def train_function(self, expert_dataset: Dataset, writer, eval_env, args):
        ...
        :param expert_dataset: _description_
        :type expert_dataset: Dataset
        :param writer: _description_
        :type writer: _type_
        :param eval_env: _description_
        :type eval_env: _type_
        :param args: _description_
        :type args: _type_
        :return: _description_
        :rtype: _type_
    ...
    def sample_actions(
        ...
        :param observations: _description_
        :type observations: jnp.ndarray
        :param random_tempurature: _description_, defaults to 1.0
        :type random_tempurature: float, optional
        :param training: _description_, defaults to False
